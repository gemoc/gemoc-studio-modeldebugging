...
import org.eclipse.gemoc.xdsmlframework.behavioralinterface.behavioralInterface.EventType;
...
public class EventManagerViewPart extends EngineSelectionDependentViewPart implements IEngineAddon {
	...
	private BehavioralInterface selectedBehavioralInterface;
	...
	private void selectBehavioralInterface() {
		...
		selectedBehavioralInterface = behavioralInterfaces.get(behavioralInterfaceList.getSelectionIndex());
