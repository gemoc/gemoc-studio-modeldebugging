 ...
 * @generated
 */
public class GenericeventSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GenericeventPackage.GENERIC_EVENT: {
			...
			case GenericeventPackage.RULE_ID: {
				RuleID ruleID = (RuleID)theEObject;
				T result = caseRuleID(ruleID);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericeventPackage.RULE_FQN: {
				RuleFQN ruleFQN = (RuleFQN)theEObject;
				T result = caseRuleFQN(ruleFQN);
				if (result == null) result = caseRuleID(ruleFQN);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericeventPackage.RULE_REF: {
				RuleRef ruleRef = (RuleRef)theEObject;
				T result = caseRuleRef(ruleRef);
				if (result == null) result = caseRuleID(ruleRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rule FQN</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rule FQN</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRuleFQN(RuleFQN object) {
		return null;
	}
